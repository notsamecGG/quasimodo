...
impl Vertex {
    ...
    // describe the layout of a single vertex
...
const VERTICES: &[Vertex] = &[
    Vertex { position: [-0.5, -0.5, 0.0], color: [0.0, 1.0, 0.0] }, // v0
    Vertex { position: [ 0.5, -0.5, 0.0], color: [0.0, 0.0, 1.0] }, // v1
    Vertex { position: [-0.5,  0.5, 0.0], color: [1.0, 0.0, 0.0] }, // v2
    Vertex { position: [ 0.5,  0.5, 0.0], color: [1.0, 0.0, 0.0] }, // v3
];
...
impl InstanceRaw {
    // Describe the layout of the raw instance in memory.
    fn desc() -> wgpu::VertexBufferLayout<'static> {
        wgpu::VertexBufferLayout {
    ...
    async fn new(window: Window) -> Self {
        ...
        let instances = vec![
            Instance {
                ...
                rotation: glam::Quat::from_axis_angle(glam::Vec3::Y, 20.0),
                color: (1.0, 0.0, 0.0).into(),
            },
            Instance {
                position: (2.0, 0.0, 0.0).into(),
                rotation: glam::Quat::from_axis_angle(glam::Vec3::Z, -20.0),
